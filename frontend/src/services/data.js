...
export const popularBuildings = [
  ...
  { id: '3', cityId: '3', name: 'Empire State Building', image: 'https://cdn.calendarz.com/uploads/events/may/1/41113/empire-state-building_compressed.jpg' },
  ...
  { id: '6', cityId: '6', name: 'Sagrada Família', image: 'https://lelephant-larevue.fr/wp-content/uploads/2018/03/%CE%A3%CE%B1%CE%B3%CF%81%CE%B1%CC%81%CE%B4%CE%B1_%CE%A6%CE%B1%CE%BC%CE%B9%CC%81%CE%BB%CE%B9%CE%B1_2941.jpg' },
];
